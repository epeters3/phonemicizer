...
The code that builds the training corpus is my own code. It takes NLTK's version of the CMU Pronunciation Dictionary and builds a training corpus of over 122,000 training instances. I also added a Levenshtein similarity metric that can be used to classify model accuracy.
